...
template<typename Name, typename I, typename OptJson = tank_options_json<> >
class tank_package
  : public waffel_package< Name, tank_domain<Name, I, typename OptJson::target>, OptJson, stat_tank_options_json >
{
  
  typedef tank_domain<Name, I, typename OptJson::target> tank_type;
  typedef waffel_package< Name, tank_domain<Name, I, typename OptJson::target>, OptJson, stat_tank_options_json > super;
public: 
